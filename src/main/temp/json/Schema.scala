...
object Schema {
  ...
  final object `object` {
    ...
    final object Free {
      def apply[T](): `object`[T] with Free = new `object`[T](ListSet.empty) with Free
    }
    ...
    def apply[T](field: Field[_], xs: Field[_]*): `object`[T] = new `object`(ListSet.from(field +: xs.toSeq))
  }
